...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center pt-36 sm:pt-44 pb-20 overflow-hidden bg-gradient-to-b from-[#F8F9FA] via-[#FCFCFC] to-[#F1F5F9]/50 dark:from-[#090D16] dark:via-[#0E1322] dark:to-[#090D16]">
      {/* Background Glows */}

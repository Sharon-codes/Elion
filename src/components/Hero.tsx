...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[82vh] sm:min-h-[88vh] flex items-center justify-center pt-28 sm:pt-40 pb-16 sm:pb-20 overflow-hidden bg-gradient-to-b from-[#F8F9FA] via-[#FCFCFC] to-[#F1F5F9]/50 dark:from-[#090D16] dark:via-[#0E1322] dark:to-[#090D16]">
      {/* Background Glows */}
      ...
      {/* Diagonal-Moving Chemistry Blueprint Background */}
      <MolecularCanvas />

      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        {/* Status Pill */}
        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-1.5 rounded-full glass-panel-elevated text-[11px] sm:text-xs font-medium text-slate-800 dark:text-slate-200 shadow-sm border border-slate-200/80 dark:border-slate-700/80 mb-6 sm:mb-8 animate-fade-in hover:border-blue-400/60 transition-all cursor-default">
          ...
          <span className="text-blue-600 dark:text-blue-400 font-semibold font-mono text-[10px] sm:text-[11px] shrink-0">35 BIOPHYSICAL GATES</span>
        </div>

        {/* Widescreen 2-Line Headline (Unclumped & Sleek) */}
        <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.16] mb-6 max-w-5xl lg:max-w-6xl font-sans">
          End-to-End AI Drug Discovery.{" "}
          <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 dark:from-blue-400 dark:via-blue-500 dark:to-cyan-400 bg-clip-text text-transparent">
            Running on Your Local GPU.
          </span>
        </h1>

        {/* Sub-headline with generous breathing space */}
        <p className="text-sm sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-3xl leading-relaxed font-normal mb-8 sm:mb-10">
